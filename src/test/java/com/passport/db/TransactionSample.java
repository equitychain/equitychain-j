package com.passport.db;// Copyright (c) 2011-present, Facebook, Inc.  All rights reserved.
...
public class TransactionSample {
  ...
  public static final void main(final String args[]) throws RocksDBException {
    ...
    OptimisticTransactionDB optimisticTransactionDB = OptimisticTransactionDB.open(new Options(),"d:/aa");
