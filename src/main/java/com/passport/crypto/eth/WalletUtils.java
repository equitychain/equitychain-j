...
<<<<<<< HEAD
=======
import static com.passport.crypto.eth.Hash.sha256;
import static com.passport.crypto.eth.Keys.ADDRESS_LENGTH_IN_HEX;
import static com.passport.crypto.eth.Keys.PRIVATE_KEY_LENGTH_IN_HEX;
...
<<<<<<< HEAD
    public static ECKeyPair generateNewWalletFile(
     ...
     * @throws IOException if the destination cannot be written to
     */
    public static Bip39Wallet generateBip39Wallet(String password, String mnemonic,File destinationDirectory)
            throws Exception {
        byte[] initialEntropy = new byte[16];
        secureRandom.nextBytes(initialEntropy);
    ...
    public static Bip39Wallet generateBip39Wallet(String password,String mnemonic)
            throws Exception {
        byte[] initialEntropy = new byte[16];
        secureRandom.nextBytes(initialEntropy);
/*
