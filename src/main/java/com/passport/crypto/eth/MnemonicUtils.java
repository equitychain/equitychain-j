...
public class MnemonicUtils {
   ...
   *
   * <h3>Mnemonic generation algorithm</h3> Given a randomly generated initial entropy of size ENT,
   * first a checksum is generated by taking the first {@code ENT / 32} bits of its SHA256 hash.
   * This checksum is appended to the end of the initial entropy. Next, these concatenated bits are
   * split into groups of 11 bits, each encoding a number from 0-2047, serving as an index into a
   * wordlist. Finally, we convert these numbers into words and use the joined words as a mnemonic
   * sentence.
   *
