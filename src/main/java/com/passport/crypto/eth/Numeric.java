...
import com.passport.exception.MessageDecodingException;
import com.passport.exception.MessageEncodingException;
...
public final class Numeric {
  ...
  public static final String HEX_PREFIX = "bx";
  ...
  public static boolean containsHexPrefix(String input) {
    return !Strings.isEmpty(input) && input.length() > 1
        && input.charAt(0) == 'b' && input.charAt(1) == 'x';
  }
